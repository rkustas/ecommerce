...
export default function Profile() {
    ...
    return (
        ...
        <Jumbotron fluid>
            <Container>
                <h1 className="text-center">Hello {values.username}!</h1>
            </Container>
        </Jumbotron>
        <Container>
            <div>
                <div style={{
                    ...
                    <div>
                        ...
                        src="https://media-exp1.licdn.com/dms/image/C4E03AQESA9cm_tCYow/profile-displayphoto-shrink_200_200/0?e=1603929600&v=beta&t=dXSYQ2p67McGlDnzyuH7_dqBNcUMPwKTGJ2yrs0onQk" alt=""/>
                    </div>
